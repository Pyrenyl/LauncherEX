...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        const val PRIVATE_SPACE_SECRET_CODE_KEY: String = "pref_private_space_secret_code"
        const val PRIVATE_SPACE_SECRET_CODE_MAX_LENGTH: Int = 12
        ...
        @JvmField val PRIVATE_SPACE_SECRET_CODE =
            backedUpItem(PRIVATE_SPACE_SECRET_CODE_KEY, "3825")
